...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ethros-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ethros-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ethros transaction") + "\n" +
              "  ethros-tx [options] -create [commands]   " + _("Create hex-encoded ethros transaction") + "\n" +
              "\n";
