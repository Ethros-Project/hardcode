...
{
    const char* pszTimestamp = "2021 Ethros is born";
    const CScript genesisOutputScript = CScript() << ParseHex("040184710fa689ad5020104c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1616948461, 2000075705, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7a9c9ed4e9fea78a645cf39c11bcd3c3cf93bdf99662e78936740a33311d8ca6"));
        assert(genesis.hashMerkleRoot == uint256S("0xcf5194f6fccc637bdfb40fc07955ab9acf4079ba942eee659031be2c7e6e62d1"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("18.222.180.20", "18.222.180.20", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("ethrostools.com", "dnsseed.ethrostools.com"));
        //vSeeds.push_back(CDNSSeedData("ethrospool.org", "dnsseed.ethrospool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x7a9c9ed4e9fea78a645cf39c11bcd3c3cf93bdf99662e78936740a33311d8ca6"))
        ...
        chainTxData = ChainTxData{
            ...
            1616948461, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1616948461, 682751, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x28d3f7994e81ea0584dcd12ef3de062fdb02d60a201399526ea5ade88ee9c9e5"));
        assert(genesis.hashMerkleRoot == uint256S("0xcf5194f6fccc637bdfb40fc07955ab9acf4079ba942eee659031be2c7e6e62d1"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("18.222.180.20", "18.222.180.20"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.ethros.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x28d3f7994e81ea0584dcd12ef3de062fdb02d60a201399526ea5ade88ee9c9e5 ")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1616948461, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb78c0da70ec761ac65a045ee40e8acc555fdc0161fc795ee5994b27cefa2b8b6"));
        assert(genesis.hashMerkleRoot == uint256S("0xcf5194f6fccc637bdfb40fc07955ab9acf4079ba942eee659031be2c7e6e62d1"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xb78c0da70ec761ac65a045ee40e8acc555fdc0161fc795ee5994b27cefa2b8b6"))
        };
