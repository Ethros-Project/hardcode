...
const char * const BITCOIN_CONF_FILENAME = "ethros.conf";
const char * const BITCOIN_PID_FILENAME = "ethros.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Ethros";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Ethros";
#else
    // Unix
    return pathRet / ".ethros";
#endif
#endif
}
